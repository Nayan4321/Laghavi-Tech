# CallGear → Zenoti Screen-Pop (Node.js version)
...
**Only use this version if your Hostinger plan has the Node.js app manager**
(hPanel → Advanced → Node.js). If it doesn't — most basic shared plans don't
— use `../php/README.md` instead, which does the same thing with plain PHP
files any shared hosting plan already supports.
